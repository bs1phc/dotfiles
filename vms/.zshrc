...
# Uncomment the following line to disable bi-weekly auto-update
#checks.
...
#edit configs
alias zshconf='nvim ~/repos/configurations/nvim/.zshrc'
alias vimconf='vim ~/repos/configurations/.config/nvim/init.vim'
alias i3conf="nvim ~/repos/configurations/vms/.config/i3/config"
